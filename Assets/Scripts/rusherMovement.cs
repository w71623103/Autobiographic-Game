...
public class rusherMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        targetPos = Instantiate(targetPosType, new Vector2(transform.position.x, yLocator.transform.position.y), Quaternion.identity);
    }
    void FixedUpdate()
    {
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            collision.gameObject.GetComponent<playerMood>().mood -= 5;
        }
    }
}
